...
from floss.language.zig.extract import extract_zig_strings
...
def main():
    ...
    zig_strings = extract_zig_strings(path, args.min_length)
    ...
    get_extract_stats(pe, static_strings, zig_strings, args.min_length, 0)
