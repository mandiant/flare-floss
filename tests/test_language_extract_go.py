...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "adaptivestackstart", 0xA1BA0, StringEncoding.UTF8, "go_strings32"
        ),
        # .data:00534944 A0 35 4A 00                       dd offset aAdaptivestacks ; "adaptivestackstart"
        # .data:00534948 12                                db  12h
        pytest.param(
            "adaptivestackstart", 0xA9E33, StringEncoding.UTF8, "go_strings64"
        ),
    ],
)
def test_data_string_offset(request, string, offset, encoding, go_strings):
    ...
    ) in request.getfixturevalue(go_strings)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "write of Go pointer ", 0xAAAC2, StringEncoding.UTF8, "go_strings64"
        ),
        ...
        pytest.param(
            "write of Go pointer ", 0xA2809, StringEncoding.UTF8, "go_strings32"
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "comparing uncomparable type ", 0xACBA4, StringEncoding.UTF8, "go_strings64"
        ),
        ...
        pytest.param(
            "comparing uncomparable type ", 0xA4964, StringEncoding.UTF8, "go_strings32"
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "out of memory (stackalloc)", 0xAC569, StringEncoding.UTF8, "go_strings64"
        ),
        # NOTE: for 32-bit, the string is present in binary file but is not referenced by any instruction
        ...
        pytest.param(
            "out of memory (stackalloc)", 0xA430E, StringEncoding.UTF8, "go_strings32"
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "ExpandEnvironmentStringsW", 0xABE91, StringEncoding.UTF8, "go_strings64"
        ),
        ...
        pytest.param(
            "ExpandEnvironmentStringsW", 0xA3C36, StringEncoding.UTF8, "go_strings32"
        ),
    ],
)
